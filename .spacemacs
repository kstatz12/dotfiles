...
values."
  (setq-default
   ...
   ;; If non-nil             '((erc :variables
   dotspacemacs-ask-for-lazy-installation t
   ;; If non-nil layers wi'((erc :variables
   ;; List of additional pa(erc :variables
   ;; Paths must have a trailing slas '((erc :variables
   ...
   ;; wrapped increasen a layer. If you need some configuration for these
