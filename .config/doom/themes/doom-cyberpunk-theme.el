;;; doom-custom-theme.el --- custom theme for Doom Emacs -*- no-byte-compile: t; -*-
;;; Commentary:
;;; Code:
;;
(require 'doom-themes)
  ...
  ((bg         '("#000b1e" nil       nil            ))
   ...
   (-modeline-pad
    (when doom-cyberpunk-padded-modeline
      (if (integerp doom-cyperpunk-padded-modeline) doom-cyberpunk-padded-modeline 4)))
